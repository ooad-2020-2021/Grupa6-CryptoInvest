...
namespace CryptoInvestt.Models
{
    public class NovcanikController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,UkupniIznos")] Novcanik novcanik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,UkupniIznos")] Novcanik novcanik)
        {
            if (id != novcanik.ID)
            {
                return NotFound();
